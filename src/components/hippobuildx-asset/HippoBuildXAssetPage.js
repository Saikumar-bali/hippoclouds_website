...
export default function HippoBuildXAssetPage() {
  return (
    <Box>
      <HeroSection>
        <Container maxWidth="md" sx={{ position: 'relative', height: '100%', display: 'flex', alignItems: 'center' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} sx={{ ml: 4, textAlign: 'left' }}>
            ...
            <Typography variant="h5" component="p">
              Comprehensive asset management for your construction equipment and machinery.
            </Typography>
          </motion.div>
        </Container>
      </HeroSection>
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Paper sx={{ p: 4, mt: 6, borderRadius: 4, textAlign: 'center', background: '#f5f5f5' }}>
          ...
          <Typography variant="body1" paragraph color="text.secondary">
            HippoBuildX – Asset offers features like asset tracking, maintenance scheduling, utilization monitoring, and depreciation management. It's designed to maximize asset lifespan and optimize operational efficiency.
          </Typography>
        </Paper>
        ...
        <Box sx={{ textAlign: 'center', mt: 6 }}>
          ...
          <Typography variant="body1" paragraph>
            Manage your assets smarter with HippoBuildX.
          </Typography>
