...
export default function HippoHRMPage() {
  return (
    <Box>
      <HeroSection>
        <Container maxWidth="md" sx={{ position: 'relative', height: '100%', display: 'flex', alignItems: 'center' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} sx={{ ml: 4, textAlign: 'left' }}>
            ...
            <Typography variant="h5" component="p">
              Streamline your HR processes with our comprehensive Human Resource Management solution.
            </Typography>
          </motion.div>
        </Container>
      </HeroSection>
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Paper sx={{ p: 4, mt: 6, borderRadius: 4, textAlign: 'center', background: '#f5f5f5' }}>
          ...
          <Typography variant="body1" paragraph color="text.secondary">
            HippoHRM offers a suite of features including employee management, payroll processing, attendance tracking, leave management, and performance appraisals. It's designed to simplify HR operations and enhance employee experience.
          </Typography>
        </Paper>
